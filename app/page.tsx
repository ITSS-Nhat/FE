...
export default function LandingPage() {
  const features = [
    {
      title: "人気ランキング",
      description: "お客様の評価とお気に入りに基づいて、最も人気のある料理を発見",
    ...
    {
      title: "レビュー機能",
      description: "実際のお客様からの本物のレビューを読んで、あなたの経験を共有",
      image: "/spring-rolls-fresh-vietnamese.png",
    },
    {
      title: "AI紹介サポート",
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 py-5 flex items-center justify-between">
          <h1 className="text-xl font-bold text-foreground tracking-tight">ベトめしガイド</h1>
